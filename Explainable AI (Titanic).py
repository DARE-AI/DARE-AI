# -*- coding: utf-8 -*-
"""Titanic CatBooster XAI

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/18W3eNozYUpntxfMg84NySo8arIpOb34M
...
mydata = pd.read_csv('/content/drive/My Drive/XAI CSV/train.csv')
...
shap.dependence_plot("Gender", shap_values, X)
...
plt.title('Passenger (id: {})'.format(3))
...
plt.ylabel('SHAP')
plt.xlabel('Features sorted by SHAP')
plt.title('Passenger (id: {})'.format(55))
